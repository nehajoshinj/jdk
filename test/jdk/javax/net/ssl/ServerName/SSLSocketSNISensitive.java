...
public class SSLSocketSNISensitive {
    ...
    void doServerSide() throws Exception {
        ...
        try {
            ...
            System.out.println("Closed SSL server socket");
        }
    }
    ...
    void doClientSide() throws Exception {
        ...
        System.out.println("Server : " + clientRequestedHostname + "is ready");
        ...
        try {
            ...
            sslOS.write('B');
            System.out.println("Client successfully established a connection to : - " + clientRequestedHostname + ":" + serverPort);
            sslOS.flush();
            sslIS.read();
            ...
            sslSocket.close();
            System.out.println("Closed SSL client socket");
        }
    }

    /**
     * Method to check certificates.
     *
     * @param certs
     * @param hostname
     * @throws Exception
    ...
    SSLSocketSNISensitive() throws Exception {
        ...
        /*
         * If both failed, return the current thread's exception, but also
         * print the remote side Exception
         */
        if ((local != null) && (remote != null)) {
            System.out.println("Both the client and the server have thrown exceptions.");
            System.out.println(whichRemote + "exception : ");
